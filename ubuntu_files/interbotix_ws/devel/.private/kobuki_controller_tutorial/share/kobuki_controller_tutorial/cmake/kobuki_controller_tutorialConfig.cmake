...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_controller_tutorial_SOURCE_PREFIX /home/ubuntu/interbotix_ws/src/kobuki/kobuki_controller_tutorial)
  set(kobuki_controller_tutorial_DEVEL_PREFIX /home/ubuntu/interbotix_ws/devel/.private/kobuki_controller_tutorial)
  ...
  set(kobuki_controller_tutorial_INSTALL_PREFIX /home/ubuntu/interbotix_ws/install)
...
if(NOT "/home/ubuntu/interbotix_ws/src/kobuki/kobuki_controller_tutorial/include " STREQUAL " ")
  set(kobuki_controller_tutorial_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/interbotix_ws/src/kobuki/kobuki_controller_tutorial/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_controller_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/interbotix_ws/src/kobuki/kobuki_controller_tutorial/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/interbotix_ws/devel/.private/kobuki_controller_tutorial/lib;/home/ubuntu/catkin_ws2/devel/lib;/home/ubuntu/interbotix_ws/devel/lib;/opt/ros/noetic/lib)
